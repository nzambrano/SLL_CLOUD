...
public interface M4sllFasesRepository extends JpaRepository<M4sllFases, M4sllFasesId> {
    ...
    public Page<M4sllFases> findByIdOrganizationLitIdLitigioTfaIdTpFase(Pageable pageable,@Param("idOrganization") String idOrganization, @Param("litIdLitigio") String litIdLitigio, @Param("tfaIdTpFase") String tfaIdTpFase);
