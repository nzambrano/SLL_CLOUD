 ...
 */
@Entity
@Table(name = "sll_autor_reu", schema = "sll")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class M4sllAutorReuCustom implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M4sllAutorReuCustom)) {
            return false;
        }
        return aurSecuencia != null && aurSecuencia.equals(((M4sllAutorReuCustom) o).aurSecuencia);
    }
