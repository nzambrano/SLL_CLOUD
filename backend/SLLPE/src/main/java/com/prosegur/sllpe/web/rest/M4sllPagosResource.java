...
public class M4sllPagosResource {
    ...
    public ResponseEntity<List<M4sllPagos>> getM4sllPagos(@PathVariable("id_organization") String id_organization, @PathVariable("lit_id_litigio") String lit_id_litigio) {
        log.debug("REST request to get M4sllPagos : {}", id_organization + "|" + lit_id_litigio);

        List<M4sllPagos> M4sllPagosByInput = m4sllPagosRepository.findByIdOrganizationLitIdLitigio(id_organization, lit_id_litigio);
    ...
    /*
      ...
      public ResponseEntity<M4sllPagos> getM4sllPagos(@PathVariable("id_organization") String id_organization, @PathVariable("lit_id_litigio") String lit_id_litigio, @PathVariable("pag_secuencia") Long pag_secuencia) {
          log.debug("REST request to get M4sllPagos : {}", id_organization + "|" + lit_id_litigio + "|" + pag_secuencia);
          M4sllPagosId id = new M4sllPagosId();
      ...
      public ResponseEntity<Void> deleteM4sllPagos(@PathVariable("id_organization") String id_organization, @PathVariable("lit_id_litigio") String lit_id_litigio) {
        log.debug("REST request to delete m4sll_pagos : {}", id_organization + "|" + lit_id_litigio);
        List<M4sllPagos> M4sllPagosByInput = m4sllPagosRepository.findByIdOrganizationLitIdLitigio(id_organization, lit_id_litigio);
    ...
    */
    ...
    public ResponseEntity<Void> deleteM4sllPagos(@PathVariable("id_organization") String id_organization, @PathVariable("lit_id_litigio") String lit_id_litigio, @PathVariable("pag_secuencia") Long pag_secuencia) {
        log.debug("REST request to delete m4sll_pagos : {}", id_organization + "|" + lit_id_litigio + "|" + pag_secuencia);
        M4sllPagosId id = new M4sllPagosId();
