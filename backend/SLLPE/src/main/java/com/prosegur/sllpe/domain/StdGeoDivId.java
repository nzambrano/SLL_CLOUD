...
/**
 * StdGeoDivId generated by hbm2java
 */
@Embeddable
public class StdGeoDivId  implements java.io.Serializable {
    ...
    public StdGeoDivId(String stdIdCountry, String stdIdGeoDiv, String idOrganization) {
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof StdGeoDivId) ) return false;
        StdGeoDivId castOther = ( StdGeoDivId ) other;
