...
public interface M4sllPedidoDetRepository extends JpaRepository<M4sllPedidoDet, M4sllPedidoDetId> {
    ...
    public Long obtenerUltimaSecuencia(@Param("id_organization") String id_organization, @Param("lit_id_litigio") String lit_id_litigio, @Param("tpe_id_pedido") String tpe_id_pedido);
    ...
    public List<M4sllPedidoDet> findByIdOrganizationLitIdLitigioTpeIdPedido(@Param("id_organization") String id_organization, @Param("lit_id_litigio") String lit_id_litigio, @Param("tpe_id_pedido") String tpe_id_pedido);
